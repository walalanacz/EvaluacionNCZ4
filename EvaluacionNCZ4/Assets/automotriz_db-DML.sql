...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-08-2022 a las 06:38:56
...
ALTER TABLE `auto`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `automotora_fk` (`AutomotoraId`);

--
-- Indices de la tabla `automotora`
--
...
--
-- AUTO_INCREMENT de la tabla `automotora`
--
ALTER TABLE `automotora`
...
--
ALTER TABLE `auto`
  ADD CONSTRAINT `automotora_fk` FOREIGN KEY (`AutomotoraId`) REFERENCES `automotora` (`Id`);
COMMIT;
